...
const buttonVariants = {
    ...
    blue: "bg-blue-600 text-white border-2 border-blue-500 hover:bg-blue-700",
};
...
export const ButtonsTest = ({ 
    ...
    const baseClasses = "rounded-round text-neutral-white border-borderWidth-md flex flex-row items-center justify-center gap-1 cursor-pointer";
